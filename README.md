...
- Information about the bakery and café, briefly detailing the services available to customers in store and information about the custom cake service provided. This information is displayed in two columns with an accompanying image below on larger screens, and on mobile devices display stacked vertically.
...
- Images of a selection of products available to purchase at the bakery and examples of custom celebration cakes created for previous customers. These images are displayed in a responsive column format which displays a different number of columns depending on screen size.
